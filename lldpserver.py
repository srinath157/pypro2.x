"""
LLDP Server - Sends lldp packet using Scapy library using python 2.x
"""
import os
import time
...
def create_simple_lldp_packet(mac_addr,hostname):
...
if __name__ == '__main__':
    ...
    while True:
        for intf in intflist:
            print intf[0], intf[1]
            packet = create_simple_lldp_packet(intf[1],hostname)
